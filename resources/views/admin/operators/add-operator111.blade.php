            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input name="operator_name" id="operator_name" class="form-control" aria-describedby="emailHelp"
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input name="operator_email" id="operator_email" class="form-control" aria-describedby="emailHelp" 
                ...
                <div class="form-group">
                  ...
                  <input name="operator_phone" id="operator_phone" class="form-control" aria-describedby="emailHelp"
                    placeholder="Enter Mobile Number" type="text">
                </div>
                <div class="form-group">
                  {{-- <label for="operator_address">Operator Address</label> --}}
                  <textarea name="operator_address" id="operator_address" rows="2" cols="20" class="form-control" 
